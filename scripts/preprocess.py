...
from mlops_lab.preprocessing.preprocessor import Preprocessor
...
def main():
    ...
    pre = Preprocessor(args.train_path, args.test_path)
    pre.load_data()
    pre.clean_data()
    train_processed, test_processed = pre.split_data()
